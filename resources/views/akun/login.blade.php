...
<body>
    ...
    {{-- <style>
.auth-left.bg-main-50 {
    background-color: #069a811c !important; 
    /* 2ECA7F */
    /* d1e7dd */
    /* 069a4b1c */
}
...
<!--==================== Sidebar Overlay End ====================-->
    ...
    <section class="auth d-flex">
        <div class="auth-left bg-main-50 flex-center p-24" >
            <img src="assets/admin/images/logo/rektorat.jpg" alt="" style="width: 900px;">
        </div>
        <div class="auth-right py-40 px-24 flex-center flex-column">
            ...
            <div class="auth-right__inner mx-auto w-100">
                {{-- Ubah untuk link nya ke home --}}
                <a href="https://www.unand.ac.id/" class="auth-right__logo">
                    <img src="assets/admin/images/logo/logo.svg" alt=""></a> 
                </a>
