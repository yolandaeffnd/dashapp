        ...
        <div class="card p-3">
            <div class="card-body">
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-12">
                        <canvas id="chartDosen" style="max-height:600px; width:100%;"></canvas>
                    </div>
                </div>
            ...
            options: {
                ...
                scales: {
                    y: {
                        ...
                        grace: '5%',
                        grid: {
                            color: "rgba(200, 200, 200, 0.3)" // Ubah warna grid agar tidak terlalu mencolok
                        }
                    },
                    x: {
                        ticks: {
                    ...
                    // x: {
                    //     ticks: {
                    //         maxRotation: 45, // Putar 45 derajat agar lebih rapi
                    //         minRotation: 45
                    //     }
                    // }
                },
