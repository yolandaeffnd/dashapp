        ...
        <div class="card-body">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-4 col-md-4 col-sm-12 mb-3">
                    ...
                    <select id="filterStatusKepegawaian" class="form-select">
...
<script>
    ...
    let chartTendik = new Chart(ctx, {
        type: 'bar',
        data: { labels: [], datasets: [{ label: 'Jumlah Tendik', data: [], backgroundColor: '#4a90e2' }] },
        options: {
            responsive: true,
            plugins: {
    ...
    function updateTable() {
        ...
        const filtered = dataApi.filter(item =>
            ...
            (!jk || item.jenis_kelamin === jk) &&
            (!status_kepegawaian || item.status_kepegawaian === status_kepegawaian) &&
            (!currentKlasifikasiJabatan || (item.klasifikasi_jabatan || 'Tanpa Klasifikasi') === currentKlasifikasiJabatan)
        );
